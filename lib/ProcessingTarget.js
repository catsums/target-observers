...
exports.ProcessingTarget = exports.ProcessingTargetEvent = void 0;
...
exports.ProcessingTargetEvent = ProcessingTargetEvent;
class ProcessingTarget extends EventTarget {
    FPS = 12;
    targetName = (0, my_1.randomID)('[ProcessingTarget:', ']');
    connectId = (0, my_1.randomID)('ConnectID:');
    ...
    get frameTime() { return (0, my_1.safeDivide)(1, this.FPS); }
    ...
    onPreProcess(timestamp) {
        try {
            ...
            let fixedDelta = (0, my_1.safeDivide)(1, this.FPS);
    ...
    connectElement(element) {
        let connectId = (0, my_1.randomID)('ConnectID:');
    ...
    isConnectedToElement(element) {
        return (0, my_1.findItem)(Object.values(this._connectedObjects), element);
    }
    logsOn() {
        this._logs = true;
    }
