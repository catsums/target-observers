            ...
            case "boundingrect":
              {
                ...
                } else if (_intersect && !(0, import_ElementFunctions.compareJSON)(_intersect, proxy.currentCollisions.find((_c) => _c.id == targID)?.intersect)) {
                  _collisionData = {
                    targetID: targID,
                    target: targElem,
                    rect: opt,
            ...
            case "transformrect":
              {
                ...
                if (_intersects && !proxy.currentCollisions.find((_c) => _c.id == targID)) {
                  ...
                  _collisionData.intersect = null;
                } else if (_intersects && !(0, import_ElementFunctions.compareJSON)(_intersects, proxy.currentCollisions.find((_c) => _c.id == targID)?.intersect)) {
                  _collisionData = {
                    targetID: targID,
                    target: targElem,
                    rect: opt,
