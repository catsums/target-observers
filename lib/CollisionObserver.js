...
class CollisionObserver extends ProcessingTarget_1.ProcessingTarget {
    ...
    constructor(callback = (entries, obs) => { }, { FPS = 12, frameTolerance = Math.sqrt(Math.E) / 1000, active = false, precision = 0.001, tolerance = 0.001 }) {
                        ...
                        case 'boundingrect':
                            {
                                ...
                                else if (_intersect && !(0, ElementFunctions_1.compareJSON)(_intersect, proxy.currentCollisions.find(_c => (_c.id == targID)))) {
                                    _collisionData = {
                                        targetID: targID,
                                        target: targElem,
                                        rect: opt,
                        ...
                        case 'transformrect':
                            {
                                ...
                                else if (_intersects && !(0, ElementFunctions_1.compareJSON)(_intersects, proxy.currentCollisions.find(_c => (_c.id == targID)))) {
                                    _collisionData = {
                                        targetID: targID,
                                        target: targElem,
                                        rect: opt,
